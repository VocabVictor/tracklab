...
try:
    ...
    from tracklab.integration.ultralytics.bbox_utils import (
        plot_bbox_predictions,
        plot_detection_validation_results,
    )
    from tracklab.integration.ultralytics.classification_utils import (
        plot_classification_predictions,
        plot_classification_validation_results,
    )
    from tracklab.integration.ultralytics.mask_utils import (
        plot_mask_predictions,
        plot_sam_predictions,
        plot_segmentation_validation_results,
    )
    from tracklab.integration.ultralytics.pose_utils import (
...
class WandBUltralyticsCallback:
    ...
    Example:
        ...
        from tracklab.yolov8 import add_wandb_callback
