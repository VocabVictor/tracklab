...
import tracklab
from tracklab.sdk.integration_utils.auto_logging import Response
...
class HuggingFacePipelineRequestResponseResolver:
    ...
    This is based off (from tracklab.sdk.integration_utils.auto_logging import RequestResponseResolver)
    """
