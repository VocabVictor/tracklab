...
from tracklab._pydantic import GQLBase, GQLId, SerializedToJson, Typename
...
class SendNotification(_BaseActionInput, NotificationActionInput):
    ...
    # Note: Validation aliases are meant to provide continuity with prior `tracklab.alert()` API.
    title: str = ""
