...
from tracklab.sdk.launch import utils as launch_utils
from tracklab.sdk.launch._launch_add import _launch_add
from tracklab.sdk.launch.errors import ExecutionError, LaunchError
...
def launch_agent(
    ...
    import tracklab.sdk.launch._launch as _launch
...
@artifact.command(context_settings=CONTEXT, help="Download an artifact from tracklab")
@click.argument("path")
