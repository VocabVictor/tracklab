...
import tracklab
import tracklab.integration.sagemaker as sagemaker
...
class _WandbSetup:
    ...
    def __init__(
        ...
        self._active_runs: list[tracklab_run.Run] = []
    ...
    def add_active_run(self, run: tracklab_run.Run) -> None:
    ...
    def remove_active_run(self, run: tracklab_run.Run) -> None:
    ...
    @property
    def most_recent_active_run(self) -> tracklab_run.Run | None:
    ...
    @property
    def settings(self) -> tracklab_settings.Settings:
