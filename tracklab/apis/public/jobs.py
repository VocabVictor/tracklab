...
from tracklab.sdk.data_types._dtypes import InvalidType, Type, TypeRegistry
...
if TYPE_CHECKING:
    from tracklab.apis.public import Api, RetryingClient
    ...
    def call(
        ...
        Args:
            ...
            priority (int, optional): The priority of the queued run.
                Defaults to None.
        """
        from tracklab.sdk.launch import _launch_add
