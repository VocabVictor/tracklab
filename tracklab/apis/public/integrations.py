...
if TYPE_CHECKING:
    from tracklab.apis.paginator import _Client
    from tracklab.automations import Integration, SlackIntegration, WebhookIntegration
...
class Integrations(Paginator["Integration"]):
    ...
    def __init__(self, client: _Client, variables: dict[str, Any], per_page: int = 50):
        from tracklab.automations._generated import INTEGRATIONS_BY_ENTITY_GQL
    ...
    def _update_response(self) -> None:
        ...
        from tracklab.automations._generated import IntegrationConnectionFields
    ...
    def convert_objects(self) -> Iterable[Integration]:
        ...
        from tracklab.automations.integrations import _IntegrationEdge
...
class WebhookIntegrations(Paginator["WebhookIntegration"]):
    ...
    def convert_objects(self) -> Iterable[WebhookIntegration]:
        ...
        from tracklab.automations import WebhookIntegration
...
class SlackIntegrations(Paginator["SlackIntegration"]):
    ...
    def __init__(self, client: _Client, variables: dict[str, Any], per_page: int = 50):
        from tracklab.automations._generated import SLACK_INTEGRATIONS_BY_ENTITY_GQL
    ...
    def _update_response(self) -> None:
        """Fetch and parse the response data for the current page."""
        from tracklab.automations._generated import SlackIntegrationConnectionFields
    ...
    def convert_objects(self) -> Iterable[SlackIntegration]:
        ...
        from tracklab.automations import SlackIntegration
