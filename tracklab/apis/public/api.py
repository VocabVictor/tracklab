...
from tracklab.apis.public.const import RETRY_TIMEDELTA
from tracklab.apis.public.registries._utils import fetch_org_entity_from_organization
from tracklab.apis.public.registries.registries_search import Registries
...
from tracklab.sdk.lib import retry, runid
...
if TYPE_CHECKING:
    ...
    from tracklab.automations._utils import WriteAutomationsKwargs
...
class Api:
    ...
    def integrations(
        ...
        *,
        ...
        """
        from tracklab.apis.public.integrations import Integrations
    ...
    def webhook_integrations(
        ...
        Examples:
            ...
            ```
        """
        from tracklab.apis.public.integrations import WebhookIntegrations
    ...
    def slack_integrations(
        ...
        Examples:
            ...
            ```
        """
        from tracklab.apis.public.integrations import SlackIntegrations
    ...
    def _omitted_automation_fragments(self) -> Set[str]:
        ...
        removed from the body of the GraphQL request:
            ...
            - Fragment spread in selection set:
                ...
                ```
        """
        from tracklab.automations import ActionType
    ...
    def create_automation(
        ...
        **kwargs: Unpack["WriteAutomationsKwargs"],
        ...
        Examples:
            ...
            ```
        """
        from tracklab.automations import Automation
        from tracklab.automations._generated import CREATE_AUTOMATION_GQL, CreateAutomation
        from tracklab.automations._utils import prepare_to_create
    ...
    def update_automation(
        ...
        **kwargs: Unpack["WriteAutomationsKwargs"],
        ...
        Examples:
            ...
            ```
        """
        from tracklab.automations import ActionType, Automation
        from tracklab.automations._generated import UPDATE_AUTOMATION_GQL, UpdateAutomation
        from tracklab.automations._utils import prepare_to_update
    ...
    def delete_automation(self, obj: Union["Automation", str]) -> Literal[True]:
        ...
        """
        from tracklab.automations._generated import DELETE_AUTOMATION_GQL, DeleteAutomation
        from tracklab.automations._utils import extract_id
