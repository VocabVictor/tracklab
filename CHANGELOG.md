...
All notable changes to TrackLab will be documented in this file.
...
<!-- TrackLab changelog updates go here -->

## [0.1.0] - 2024-01-01

### Notable Changes

Initial release of TrackLab - a local experiment tracking library with 100% wandb API compatibility.

### Added

- Core SDK implementation with wandb-compatible API
- Local FastAPI backend for experiment tracking
- SQLite database for local data storage
- Basic data types support (Image, Table, Histogram, etc.)
- Local artifact management system
- Web interface for experiment visualization
- PyTorch, TensorFlow, and Scikit-learn integrations
- Complete test suite with 317 test files
