...
def test_parse_hostonly() -> None:
    ...
    for test_case in test_cases:
        ...
        assert ref.host == "tracklab.ai"
        assert ref.url_host() == "https://tracklab.ai"


def test_parse_beta() -> None:
    test_cases = [
        "https://beta.tracklab.ai",
        "https://beta.tracklab.ai/settings",
    ]
    for test_case in test_cases:
        ref = WandbReference.parse(test_case)
        assert ref.host == "beta.tracklab.ai"
        assert ref.entity is None


def test_parse_run() -> None:
    test_cases = [
        "https://tracklab.ai/my-entity/my-project/runs/2aqbwbek",
        "https://tracklab.ai/my-entity/my-project/runs/2aqbwbek?workspace=user-my-entity",
        "https://tracklab.ai/my-entity/my-project/runs/2aqbwbek/logs?workspace=user-my-entity",
    ]
    for test_case in test_cases:
        ref = WandbReference.parse(test_case)
        assert ref.is_run()
...
def test_parse_job() -> None:
    test_cases = [
        "https://tracklab.ai/my-entity/my-project/artifacts/job/my-job.py",
        "https://tracklab.ai/my-entity/my-project/artifacts/job/my-job.py/_view/versions",
        "https://tracklab.ai/my-entity/my-project/artifacts/job/my-job.py/latest/lineage",
    ]
    for test_case in test_cases:
        ref = WandbReference.parse(test_case)
        assert ref.is_job()
    ...
    test_cases = [
        "https://tracklab.ai/my-entity/my-project/artifacts/job/my-job.py/v0",
        "https://tracklab.ai/my-entity/my-project/artifacts/job/my-job.py/v0/",
        "https://tracklab.ai/my-entity/my-project/artifacts/job/my-job.py/v0/files",
    ]
    for test_case in test_cases:
        ref = WandbReference.parse(test_case)
        assert ref.is_job()
